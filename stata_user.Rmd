...
<!-- Git branches allow you to try out a new idea outside the **main** branch. For example, suppose you've reached the empirical part of your project. Say, you have a binary outcome variable and you want to choose between linear probability model and Logit model. -->
<!-- You want to keep a subset of the sample, stayers, -->